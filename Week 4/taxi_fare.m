...
% It takes two inputs: the distance in kilometers (d) and waiting time (t).
...
% function). The same rule applies to wait times. You can assume that d >0 and 
% t >= 0 but they are not necessarily integers. The function returns the fare 
% in dollars. For example, a 3.5-km ride with 2.25 minutes of wait costs 
